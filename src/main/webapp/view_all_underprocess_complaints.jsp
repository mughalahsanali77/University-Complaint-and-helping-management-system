                ...
                <div class="col-md-10">
                    <div class="card mt-3">
                        <div class="card-header  custom-bg text-center text-white">
                            <h1>All Under Process Complaints</h1>
                        </div>
                            ...
                            <table class="table table-striped table-dark">
                                ...
                                <tbody>
                                    ...
                                    <%                                        ComplaintDao cDao = new ComplaintDao(FactoryProvider.getSessionFactory());
                                        List<Complaint> complaintsList = cDao.getComplaintsByStatus("underprocess");
                                    ...
                                    <tr>
                                       ...
                                       <td><button type="button" class="btn btn-secondary "><%=c.getComplaintStatus()%></button></td>
