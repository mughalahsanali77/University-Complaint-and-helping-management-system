...
public class RegisterFacultyServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           String faacultyName=request.getParameter("faculty-title");
           String faacultyDescription=request.getParameter("faculty-detail");
            Faculty faculty=new Faculty(faacultyName, faacultyDescription);
            
           
            FacultyDao facultyDao=new FacultyDao(FactoryProvider.getSessionFactory());
            
            int facId=(int)facultyDao.saveFaculty(faculty);
            
            HttpSession session=request.getSession();
            session.setAttribute("message", "Saved Sucessfully Faculty Name="+faacultyName+" and id assigned = "+facId);
