                ...
                <div class="col-md-10">
                    <div class="card mt-3">
                        <div class="card-header  custom-bg text-center text-white">
                            <h1><%=user.getStudent().getStudentName() %>  Pending Complaints</h1>
                        </div>
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-dark">
                                ...
                                <tbody>
                                      <%
                                          int i=1;
                                          List<Complaint> complains=cdao.getStatusedComplaintsByStudentId(sid,"pending");
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="button" class="btn btn-primary"> <%=c.getComplaintStatus() %></button></td>
