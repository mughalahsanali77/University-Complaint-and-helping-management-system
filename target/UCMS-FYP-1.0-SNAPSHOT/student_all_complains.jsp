...
<html>
    <head>
        ...
        <title> Students All Compalins</title>
                ...
                <div class="col-md-10">
                    <div class="card mt-3">
                        <div class="card-header  custom-bg text-center text-white">
                            <h1><%=user.getStudent().getStudentName() %> All Complaints</h1>
                        </div>
                        ...
                        <div class="card-body">
                            <table class="table table-striped table-dark">
                                ...
                                <tbody>
                                      <%
                                          int i=1;
                                          List<Complaint> complains=cdao.getAllComplaintsByStudentId(sid);
                                    ...
                                    <tr>
                                        ...
                                        %>
                                        <td><button type="button" class="btn btn-primary">New</button></td>
                                        <%}else if(c.getComplaintStatus().equals("pending")){
                                            
                                        %>
                                         <td><button type="button" class="btn btn-primary">Assigned</button></td>
                                       
                                        <%}else if(c.getComplaintStatus().equals("underprocess")){
                                            
                                        %>
                                        <td><button type="button" class="btn btn-warning ">UnderProcess</button></td>
                                       
                                        <%}else if(c.getComplaintStatus().equals("resolved")){
                                            
                                        %>
                                        <td><button type="button" class="btn btn-success "> Resolved on <%= c.getResolveDate() %></button></td>
                                      
                                        <%}else if(c.getComplaintStatus().equals("rejected")){
                                            
                                        %>
                                      <td><button type="button" class="btn btn-danger "> Rejected on <%= c.getResolveDate() %></button></td>
