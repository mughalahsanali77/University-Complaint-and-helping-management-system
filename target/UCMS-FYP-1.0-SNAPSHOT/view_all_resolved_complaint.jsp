                            ...
                            <table class="table table-striped table-dark">
                                ...
                                <tbody>
                                    ...
                                    <%
                                        ...
                                        List<Complaint> complaintsList=cDao.getComplaintsByStatus("resolved");
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="button" class="btn btn-success "><%=c.getComplaintStatus()%></button></td>
